    ...
    jQuery.query = new function() {
        var a = function(a, b) {
            return void 0 != a && null !== a && (b ? a.constructor == b : !0)
                ...
                for (var b, c = /\[([^[]*)\]/g, d = /^(\S+?)(\[\S*\])?$/.exec(a), e = d[1], f = []; b = c.exec(d[2]);) f.push(b[1]);
                return [e, f]
            }, g = function(b, c, d) {
                var e = c.shift();
...
function($) {
    $.jmsajax = function(a) {
        ...
        if (a.method && (a.url += "/" + a.method), a.data)
            if ("GET" == a.type) {
                var c = "";
                for (var d in a.data) "" != c && (c += "&"), c += d + "=" + msJSON.stringify(a.data[d]);
        ...
        function str(a, b) {
            ...
            switch (i && "object" == typeof i && "function" == typeof i.toJSON && (i = i.toJSON(a)), "function" == typeof rep && (i = rep.call(b, a, i)), typeof i) {
                ...
                case "object":
                    if (!i) return "null";
                    if (i.toUTCString) return '"\\/Date(' + i.getTime() + ')\\/"';
                    ...
                    if (rep && "object" == typeof rep)
                        ...
                        for (d in i) Object.hasOwnProperty.call(i, d) && (e = str(d, i, rep), e && g.push(quote(d) + (gap ? ": " : ":") + e));
                    return e = 0 === g.length ? "{}" : gap ? "{\n" + gap + g.join(",\n" + gap) + "\n" + h + "}" : "{" + g.join(",") + "}", gap = h, e
            }
        }
        var cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
        ...
        return d.push("}}; TrimPath_Template_TEMP"), d.join("")
            ...
            if (null != g.prefixFunc ? c.push(g.prefixFunc(f, b, d, e)) : c.push(g.prefix), null != g.suffix) {
                if (f.length <= 1) null != g.paramDefault && c.push(g.paramDefault);
                    ...
                    for (var h = 1; h < f.length; h++) h > 1 && c.push(" "), c.push(f[h]);
                c.push(g.suffix)
            }
    ...
    a.fn.dropdown = function(b, c) {
        ...
        a.each(this, function() {
            ...
            g.bind("mouseleave", function() {
                ...
                a(this), clearTimeout(f), clearTimeout(n)
    ...
    a.fn.Jtab = function(b, c) {
        if (this.length) {
            ...
            var d = a.extend({
                ...
                e = a(this).find("*[" + d.hookKey + "=" + d.hookItemVal + "]"),
    ...
    a.fn.Jlazyload = function(b, c) {
        if (this.length) {
            var d, e, f = a.extend({
                ...
                g = this,
                h = function(a) {
                    for (var b = a.scrollLeft, c = a.scrollTop, d = a.offsetWidth, e = a.offsetHeight; a.offsetParent;) b += a.offsetLeft, c += a.offsetTop, a = a.offsetParent;
                    return {
                        left: b,
                        top: c,
                        width: d,
        ...
        var d = a.extend({
            ...
            e = function(a) {
                ...
                if (c != {} && c && c.start && c.end) {
                    var g, h, i, j = e(c.start),
                        k = e(c.server),
                        l = e(c.end),
                        m = (j - k) / 1e3,
                        n = (l - k) / 1e3,
                        o = "#" + d.mainPlaceholder + b,
                        p = "#" + d.subPlaceholder + c.qid,
            ...
            var i = function(a) {
                return function(b) {
                    ...
                    if (a = 0 > a ? 0 : f > a ? a : f - 1, c = jQuery.extend({
                        text: a + 1,
                        classes: ""
                    }, c || {}), a == g) var d = $("<a href='javascript:void(0)' class='current'>" + c.text + "</a>");
                    else var d = $("<a>" + c.text + "</a>").bind("click", i(a)).attr("href", b.link_to.replace(/__id__/, a));
...
function(a) {
    a.extend(a.browser, {
        ...
        isIE6: a.browser.msie && 6 == a.browser.version,
        isMinW: function(b) {
        ...
        switch (c.mode) {
            ...
            case "center":
                var d = a(this).outerWidth(),
                    ...
                    f = (a.browser.isMinW(d), a.browser.isMinH(e));
                a(this).css({
...
function(a) {
    a.fn.jdThickBox = function(b, c) {
        ...
        var d, e = a.extend({
            ...
            f = "function" != typeof this ? a(this) : null,
            g = function() {
        ...
        var h = function(a) {
            return "" != a ? a.match(/\w+/) : ""
                ...
                }, 100), a(".thickbox").jdPosition({
                    mode: "center"
                }), a.browser.isIE6) {
                    var c = a(".thickbox").outerWidth(),
                        d = a(".thickbox").outerHeight(),
                        f = a.browser.isMinW(c);
                    a.browser.isMinH(d), a(".thickframe").add(".thickdiv").css({
                        width: f ? c : "100%",
...
function(a) {
    ...
    a = $.extend({
        ...
        complete: null,
        modal: !1
    }, a || {}), "" != a.loginService && "" != a.loginMethod && $.getJSON(a.loginService, {
...
function(a) {
    a.jdCalcul = function(b) {
        var c = null,
            b = b.join(","),
            d = "http://qiang.jd.com/HomePageLimitBuy.ashx?callback=?&ids=" + b,
            e = "http://item.jd.com/",
            f = function(b) {
                var c = a.extend({
                    contentid: "#limit",
                ...
                if (!(b == {} || "" == b || null == c.start || "" == c.start || null == c.end || "" == c.end || c.pros.length < 1)) {
                    ...
                    var d, f, h, i, j = (c.start - c.server) / 1e3,
                        k = (c.end - c.server) / 1e3,
                        l = function() {
                            ...
                            a.each(c.pros, function(a) {
                                var f = c.pros[a].id,
                                    g = c.pros[a].tp,
                                    h = 1 == c.pros[a].zt ? "<div class='pi9'></div>" : "<div class='pi10'></div>",
                                    i = unescape(c.pros[a].mc),
                                    j = c.pros[a].qg,
                                    k = "(" + c.pros[a].zk + "\u6298)";
...
var jdRecent = {
    ...
    init: function() {
        var a = this.url.match(/\/(\d{6}).html/),
            b = null != a && -1 != a[0].indexOf("html") ? a[1] : "";
        if (this.list && null != this.list && "" != this.list) "" == b || -1 != this.list.indexOf(b) ? this.list = this.list : (this.list.split(".").length >= 10 && (this.list = this.list.replace(/.\d+$/, "")), this.list = b + "." + this.list);
        else {
            if ("" == b) return this.getData(0);
            this.list = b
        }
    ...
    getData: function(a) {
        if (0 == a) return this.element.html("<li><div class='norecode'>\u6682\u65e0\u8bb0\u5f55!</div></li>"), void 0;
        var b = a.split(".");
        for (i in b) 0 == i && this.element.empty(), $.getJSONP(this.jsurl + b[i], this.setData)
    },
    setData: function(a) {
...
$.extend(jdModelCallCenter, {
    ...
    doAttention: function(a) {
        ...
        $.login({
            modal: !0,
            complete: function(c) {
                if (null != c && null != c.IsAuthenticated && c.IsAuthenticated) {
                    var d = 510,
                        e = 440;
                    $.jdThickBox({
                        type: "iframe",
                        ...
                        var b = window._mvq = window._mvq || [];
                        b.push(["$setGeneral", "concern", "", "", ""]), b.push(["$addItem", "", a, "", "", ""]), b.push(["$logData"])
                    })
                }
            }
        })
    ...
    if (a && $.browser.msie && 6 == $.browser.version) {
        if ("undefined" == typeof b) var b = a.outerWidth();
        if ("undefined" == typeof c) var c = a.outerHeight();
        var d = '<iframe src="javascript:false;" frameBorder="0" style="width:' + b + "px;height:" + c + 'px;position:absolute;z-index:-1;opacity:0;filter:alpha(opacity=0);top:0;left:0;">';
        a.append(d)
    }
};
var category = {
    ...
    FN_GetLink: function(a, b) {
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://list.jd.com/" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
    },
    FN_SetLink: function(a) {
        var b = "",
            c = pageConfig.isHome ? 'clstag="homepage|keycount|home2013|0604e"' : "",
            d = pageConfig.isHome ? 'clstag="homepage|keycount|home2013|0603e"' : "",
            e = pageConfig.isHome ? 'clstag="homepage|keycount|home2013|0605e"' : "";
        switch (a) {
            case "c":
                b = '<div class="categorys-links" id="categorys-links-diy" ' + c + '><a href="http://diy.jd.com/" target="_blank">DIY\u88c5\u673a\u5927\u5e08</a></div>';
                break;
            case "b":
                b = '<div class="categorys-links" id="categorys-links-cellphone" ' + d + '><a href="http://sale.jd.com/act/w78AxhytLrVelbs.html" target="_blank">\u624b\u673a\u65b0\u54c1\u9986</a></div>';
                break;
            case "d":
    ...
    DATA_Simple: {
        ...
        2: [{
            l: "http://channel.jd.com/electronic.html",
            n: "\u5bb6\u7528\u7535\u5668"
        }],
        3: [{
            l: "http://shouji.jd.com/",
            n: "\u624b\u673a"
        }, {
        ...
        4: [{
            l: "http://channel.jd.com/computer.html",
            n: "\u7535\u8111\u3001\u529e\u516c"
        }],
        5: [{
            l: "http://channel.jd.com/home.html",
            n: "\u5bb6\u5c45"
        }, {
            ...
            l: "http://channel.jd.com/kitchenware.html",
            n: "\u53a8\u5177"
        }],
        6: [{
            l: "http://channel.jd.com/clothing.html",
            n: "\u670d\u9970\u5185\u8863"
        }, {
        ...
        7: [{
            l: "http://channel.jd.com/beauty.html",
            n: "\u4e2a\u62a4\u5316\u5986"
        }],
        8: [{
            l: "http://channel.jd.com/shoes.html",
            n: "\u978b\u9774"
        }, {
            l: "http://channel.jd.com/bag.html",
            n: "\u7bb1\u5305"
        }, {
            l: "http://channel.jd.com/watch.html",
            n: "\u949f\u8868"
        }, {
        ...
        9: [{
            l: "http://channel.jd.com/sports.html",
            n: "\u8fd0\u52a8\u6237\u5916"
        }],
        10: [{
        ...
        11: [{
            l: "http://channel.jd.com/baby.html",
            n: "\u6bcd\u5a74"
        }, {
        ...
        12: [{
            ...
            l: "http://channel.jd.com/wine.html",
            n: "\u9152\u7c7b"
        }, {
        ...
        13: [{
            l: "http://channel.jd.com/health.html",
            n: "\u8425\u517b\u4fdd\u5065"
        }],
        14: [{
            l: "http://caipiao.jd.com/",
            n: "\u5f69\u7968"
        }, {
            l: "http://trip.jd.com/",
            n: "\u65c5\u884c"
        }, {
            l: "http://chongzhi.jd.com/",
            n: "\u5145\u503c"
        }, {
            l: "http://piao.jd.com/",
            n: "\u7968\u52a1"
    ...
    FN_RefactorJSON: function(a, b) {
        for (var c = a.length / b, d = [], e = 0; c > e; e++) d.push({
            tabs: [],
            increment: null,
            count: b,
            skuids: []
        });
        for (var f = 0, g = 0; g < a.length; g++) 0 == g % b && f++, d[f - 1].tabs.push(a[g]), d[f - 1].increment = f, d[f - 1].skuids.push(a[g].wid);
        return d
    },
    renderItem: function(a) {
        var b = '<div class="item fore${index+1}">    <span data-split="1" {if pageConfig.isHome}clstag="homepage|keycount|home2013|0${601+parseInt(index)}a"{/if}><h3>${n}</h3><i></i><s></s></span>    <div class="i-mc">        <div onclick="$(this).parent().parent().removeClass(\'hover\')" class="close">\xd7</div>        <div class="subitem" {if pageConfig.isHome}clstag="homepage|keycount|home2013|0${601+parseInt(index)}b"{/if}>            {for subitem in i}            <dl class="fore${parseInt(subitem_index)+1}">                <dt>${category.FN_GetLink(1,subitem)}</dt>                <dd>{for link in subitem.i}<em>${category.FN_GetLink(2,link)}</em>{/for}</dd>            </dl>            {/for}        </div>        <div class="cat-right-con fr" id="JD_sort_${t}"><div class="loading-style1"><b></b>\u52a0\u8f7d\u4e2d\uff0c\u8bf7\u7a0d\u5019...</div></div>    </div></div>',
            c = '<div class="item item-col2 fore${index+1}">    <span data-split="1" {if pageConfig.isHome}clstag="homepage|keycount|home2013|0${601+parseInt(index)}a"{/if}><h3>${n}</h3><i></i><s></s></span>    <div class="i-mc">        <ul class="title-list lh">            <li class="fore1"><a href="http://chongzhi.jd.com/">\u5145\u503c\u7f34\u8d39</a></li>            <li class="fore2"><a href="http://caipiao.jd.com/">\u4eac\u4e1c\u5f69\u7968</a></li>            <li class="fore3"><a href="http://channel.jd.com/4938-12316.html">\u57f9\u8bad\u6559\u80b2</a></li>            <li class="fore4"><a href="http://jipiao.jd.com/ticketquery/flightHotcity.action">\u4f18\u9009\u673a\u7968</a></li>            <li class="fore5"><a href="http://channel.jd.com/4938-12300.html">\u65c5\u884c\u7b7e\u8bc1</a></li>        </ul>        <div onclick="$(this).parent().parent().removeClass(\'hover\')" class="close">\xd7</div>        <div class="subitem" {if pageConfig.isHome}clstag="homepage|keycount|home2013|0${601+parseInt(index)}b"{/if}>            {for item in i}            <div class="sub-item-col sub-item-col${item_index} fl">                {for subitem in item.tabs}                <dl class="fore${parseInt(subitem_index)+1}">                    <dt>${category.FN_GetLink(1,subitem)}</dt>                    <dd>{for link in subitem.i}<em>${category.FN_GetLink(2,link)}</em>{/for}</dd>                </dl>                {/for}            </div>            {/for}        </div>    </div></div>';
    ...
    getDataService: function(a) {
        ...
        var d = this,
            e = this.OBJ.outerWidth(),
            f = this.OBJ.outerHeight();
        $("#_JD_ALLSORT").dropdown({
            ...
            if (i.css({
                ...
                var j = i.outerWidth() + e,
                    k = i.outerHeight() > f ? i.outerHeight() : f;
                d.OBJ.find("iframe").css({
                    width: j,
                    height: k,
                    top: g
                })
    ...
    getBrandService: function(a) {
        ...
        this.OBJ.attr("load", "2"), $.each(c, function() {
            var a = this.id,
                c = b.getRightAreaTPL(a);
            "l" !== a && $("#JD_sort_" + a).html(c.process(this))
    ...
    FN_Init: function() {
        if (this.OBJ.length) {
            this.OBJ.attr("load") || (window.pageConfig && 0 != window.pageConfig.pageId && this.FN_InitSimple(), $("#categorys").length ? $("#categorys").Jdropdown({
                delay: 200
        ...
        FN_InitNewVList: function(a) {
            for (var b, c = a ? a.split("|") : [], d = c.length, e = [], f = 0; d > f;) e.push(c[f].split(".")[1]), f++;
            b = e.join(","), $.getJSONP("http://my.jd.com/product/info.html?ids=" + b + "&jsoncallback=UC.FN_ShowVList")
        },
        FN_InitVList: function(a) {
            for (var b = JSON.parse(a), c = b.length, d = ",", e = 0; c > e; e++) new RegExp(b[e].s).test(d) || (d += b[e].s + ",");
        ...
        FN_setWords: function(a) {
            var b = '<font style="color:{0}">({1})</font>',
                c = "";
            ...
            var a = document.getElementById("settleup") ? $("#settleup dl") : $("#settleup-2013 dl"),
                ...
                c = function(a) {
                    var c = a.Cart,
                        ...
                        e = MCART.TPL_List.sigle.process(a.Cart),
                        f = MCART.TPL_List.gift.process(a.Cart),
                        g = MCART.TPL_List.suit.process(a.Cart),
                        h = MCART.TPL_List.mz.process(a.Cart),
        ...
        init: function(a) {
            var b, c = this,
                d = this.serializeUrl(location.href),
        ...
        serializeUrl: function(a) {
            var b, c, d, e, f = a.indexOf("?"),
                ...
                j = i.length,
                k = {};
            for (b = 0; j > b; b++) c = i[b].split("="), d = c[0], e = c[1], k[d] = e;
            return {
                url: g,
                param: k
            }
...
! function() {
    ...
    }), category.FN_Init(), document.getElementById("shortcut") ? $("#shortcut .menu").Jdropdown({
        delay: 50
    }) : ($("#biz-service").Jdropdown({
        delay: 50
    }, function() {
        $.ajax({
    ...
    })), document.getElementById("navitems") ? $("#navitems li").Jdropdown() : $("#navitems-2013 li").Jdropdown(), $.ajax({
    ...
    }), document.getElementById("settleup") ? (null != MCART.DATA_Amount && ($("#settleup s").eq(0).addClass("shopping"), $("#shopping-amount").html(MCART.DATA_Amount)), $("#settleup dl").Jdropdown({
        delay: 200
    }, function() {
        MCART.FN_Refresh(), $("#settleup-url").attr("href", "http://cart.jd.com/cart/cart.html?r=" + +new Date)
    })) : (null != MCART.DATA_Amount && $("#shopping-amount").html(MCART.DATA_Amount), $("#settleup-2013 dl").Jdropdown({
        delay: 200
    }, function() {
        MCART.FN_Refresh(), $("#settleup-url").attr("href", "http://cart.jd.com/cart/cart.html?r=" + +new Date)
    }));
    ...
    a.find("dl").Jdropdown({
        ...
        a.attr("load") || $.login({
            ...
            complete: function(b) {
                if (b) {
                    var c = a.find("dd").eq(0),
                        d = "",
                        e = readCookie(UC.DATA_Cookie);
...
var $o = function() {
    function a() {
        this.length = 0, this.index = -1, this.needCreatedItem = !1, this.iLastModified = 0
    }
    var b = {};
    ...
    var c = '<a style="color:#005AA0" onclick="$o.del(event)">\u5220\u9664</a>',
        d = "\u641c\u7d22\u5386\u53f2",
        e = '<li id="d_#{id}" suggest-pos="#{suggest_pos}" title="#{title}" onclick="$o.clickItem(this)" history="1"><div class="search-item" style="color:#005AA0">#{keyword}</div><div class="search-count">' + d + "</div></li>",
        f = '<li id="d_#{id}" suggest-pos="#{suggest_pos}" title="#{title}" onclick="$o.clickItem(this)"><div class="search-item">#{keyword}</div><div class="search-count">\u7ea6#{amount}\u4e2a\u5546\u54c1</div></li>',
        g = '<div id="d_#{id}" suggest-pos="#{suggest_pos}" class="#{className}" title="#{title}" cid="#{cid}" cLevel="#{cLevel}" onclick="$o.clickItem(this)"><div class="search-item">\u5728<strong>#{cname}</strong>\u5206\u7c7b\u4e2d\u641c\u7d22</div><div class="search-count">\u7ea6#{amount}\u4e2a\u5546\u54c1</div></div>#{categorys}',
        h = '<li class="fore1"><div id="d_#{id}" suggest-pos="#{suggest_pos}" class="fore1" title="#{title}" onclick="$o.clickItem(this)"><div class="search-item">#{keyword}</div><div class="search-count" #{style}>\u7ea6#{amount}\u4e2a\u5546\u54c1</div></div>#{categorys}</li>',
        i = "http://dd.search.jd.com/?key=#{keyword}",
        j = "#FFDFC6",
        k = "#FFF",
        l = $("#key"),
        m = $("#shelper");
    a.prototype.init = function() {
        this.length = 0, this.index = -1, this.needCreatedItem = !1
    }, a.prototype.hideTip = function() {
        this.init(), m.html("").hide()
        ...
        null == e || $.trim(e).isEmpty() || l.val(e), search.additinal = "&suggest=" + a.getAttribute("suggest-pos"), search("key")
        ...
        this.needCreatedItem = !0
    }, a.prototype.mouseleave = function(a) {
        a.css("background", k), a.attr("history") && a.find(".search-count").html(d), this.needCreatedItem = !1
    }, a.prototype.selectItemNode = function(a) {
        var b = this,
            e = $("#d_" + b.index + ":visible");
        ...
        if (f.length > 0) {
            ...
            var i = f.attr("cLevel");
            search.cLevel = null != i && "" != i ? i : null, search.ev_val = null, search.additinal = "&suggest=" + f.attr("suggest-pos")
        }
    }, a.prototype.input = function() {
        var a = this,
            c = $.trim(l.val());
        if (c || readCookie("pin") || readCookie("_tp")) {
            var d = b.replace(i, {
                keyword: encodeURIComponent(c)
            });
            $.ajax({
                url: d,
                dataType: "jsonp",
        ...
        if (0 == a.length) return this.hideTip(), void 0;
        var c = this;
        c.init();
        var d = "",
            i = 0;
        ...
        for (var j = 0, k = "", n = !1, o = 0, p = $.trim(l.val()), q = 0, r = a.length; r > q; q++) {
            ...
            if (s) {
                ...
                if (0 == u && (v = p + "<strong>" + t.substring(u + p.length) + "</strong>"), "string" != typeof s.cid || $.trim(s.cid).isEmpty()) {
                    ...
                    if (0 == n) {
                        n = !0;
                        var w = 'style="visibility:hidden"',
                            x = 0;
                        s.oamount && s.oamount > 0 && (x = s.oamount, w = ""), k += b.replace(h, {
                            id: o,
                            title: s.keyword,
                            keyword: v,
                            amount: x,
                    ...
                    if ("string" == typeof s.cname && $.trim(s.cname).isEmpty()) continue;
                    var y = s.level;
                    if (!y) continue;
                    if (0 == i) {
                        if ("string" == typeof y && /^[1-8]4$/.test(y)) continue
                    } else if (5 == i) {
                        if ("string" == typeof y && !/^[5-8]2$/.test(y)) continue
                    } else if (1 == i || 2 == i || 3 == i || 4 == i) continue;
                    var z = "item1",
                        A = b.replace(g, {
                            id: o,
                            title: s.keyword,
        ...
        c.length = o, d = b.replace(k, {
            categorys: ""
        }), "" != d ? (d += '<li class="close" onclick="$o.hideTip()">\u5173\u95ed</li>', m.html(d).show(), m.find('[id^="d_"]').bind("mouseleave", function() {
            c.mouseleave($(this))
        ...
        var b = $(a.srcElement ? a.srcElement : a.target),
            c = b.parent().parent().attr("title");
        $.ajax({
            url: "http://search.jd.com/suggest.php?op=del&callback=?&key=" + encodeURIComponent(c),
            dataType: "jsonp",
            scriptCharset: "utf-8",
            beforeSend: function() {
...
pageConfig.FN_InitSidebar = function() {
    ...
    this.scroll = function() {
        ...
        screen.width >= 1210 && (b = $.browser.msie && $.browser.version <= 6 ? {
            right: "-26px"
        } : {
    ...
    var a = a || "_contrast",
        c = c || "list",
        b = b || "http://misc.360buyimg.com/contrast/js/contrast.js?ver=" + +new Date,
        d = readCookie(a + "_status");
...
}, /debug=global/.test(location.href) || $.ajax({
